# 🚀 SCRIPT TẠO GITHUB ISSUES VỚI PHÂN CÔNG 5 NGƯỜI

## 🎲 **PHÂN CÔNG CHO 5 THÀNH VIÊN (Balanced Workload):**

### 👤 **Thành Viên 1: @member1** (13 giờ)
- [EV Owner] WalletPage - Quản lý ví (5h)
- [EV Owner] ListingsPage - Quản lý listings (5h)
- [CVA] CVADashboard - Dashboard xác minh (3h)

### 👤 **Thành Viên 2: @member2** (16 giờ)
...
## 🎯 **ISSUE 1: [EV Owner] WalletPage - Quản lý ví (5h)**
...
## 🎯 **ISSUE 2: [EV Owner] ListingsPage - Quản lý listings (5h)**
...
## 🎯 **ISSUE 3: [CVA] CVADashboard - Dashboard xác minh (3h)**
...
## 🎯 **ISSUE 4: [Buyer] BuyerDashboard - Hoàn thiện dashboard (3h)**
...
## 🎯 **ISSUE 5: [Buyer] OrdersPage - Quản lý đơn hàng (4h)**
...
## 🎯 **ISSUE 6: [Buyer] CertificatesPage - Quản lý chứng chỉ (4h)**
...
## 📊 **WORKLOAD SUMMARY CHO 5 NGƯỜI**

| **Thành Viên** | **Số Issues** | **Tổng Giờ** | **Vai Trò** |
|---|---|---|---|
| **@member1** | 3 issues | **13h** | EV Owner + CVA Dashboard |
| **@member2** | 4 issues | **16h** | Buyer + CVA Reports |
| **@member3** | 3 issues | **15h** | Admin Core |
| **@member4** | 4 issues | **18h** | Admin Advanced + Integration |
| **@member5** | 3 issues | **20h** | Testing & API |
